...
import { createEmptyBoard, canPlaceShip, placeShip, randomPlaceShips, type Board } from '@/lib/game/board';
import { BOARD_SIZE, SETUP_TIMER_SECONDS } from '@/lib/utils/constants';
import { SHIPS } from '@/lib/game/ships';
import type { CharacterType, GameMode, Ship as ShipType, Position } from '@/types/game';
